...
var _CopyOutlined = require('@ant-design/icons/lib/icons/CopyOutlined');
require('antd/es/popconfirm/style');
var _Popconfirm = require('antd/es/popconfirm');
var _DeleteOutlined = require('@ant-design/icons/lib/icons/DeleteOutlined');
...
var _Collapse = require('antd/es/collapse');
...
var _UploadOutlined = require('@ant-design/icons/lib/icons/UploadOutlined');
require('antd/es/message/style');
var _message = require('antd/es/message');
require('antd/es/popover/style');
var _Popover = require('antd/es/popover');
var _PictureOutlined = require('@ant-design/icons/lib/icons/PictureOutlined');
...
var _CopyOutlined__default = /*#__PURE__*/_interopDefaultLegacy(_CopyOutlined);
var _Popconfirm__default = /*#__PURE__*/_interopDefaultLegacy(_Popconfirm);
var _DeleteOutlined__default = /*#__PURE__*/_interopDefaultLegacy(_DeleteOutlined);
...
var _UploadOutlined__default = /*#__PURE__*/_interopDefaultLegacy(_UploadOutlined);
...
var _PictureOutlined__default = /*#__PURE__*/_interopDefaultLegacy(_PictureOutlined);
...
function getValueByPath(formData, path) {
  if (path === '#' || !path) {
    ...
    return lodashEs.get(formData, path);
  } else {
...
var clone = lodashEs.cloneDeep; // export const clone = clone1;
...
var removeHiddenFromResult = function removeHiddenFromResult(data, flatten) {
  Object.keys(flatten).forEach(function (key) {
    ...
    if (lodashEs.get(data, key) !== undefined && hidden) {
      lodashEs.set(data, key, undefined);
    }
  });
  return data;
};
...
var Store2Ctx = /*#__PURE__*/React.createContext({}); // 放不常用的属性
// 使用最顶层组件的 setState
...
var useStore2 = function useStore2() {
  return React.useContext(Store2Ctx);
...
var SimpleList = function SimpleList(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(Core, fieldsProps), /*#__PURE__*/React__default['default'].createElement("div", {
      style: {
        marginTop: 6
      }
    }, !props.hideDelete && /*#__PURE__*/React__default['default'].createElement(_Popconfirm__default['default'], {
      title: "\u786E\u5B9A\u5220\u9664?",
      ...
      okText: "\u786E\u5B9A",
      cancelText: "\u53D6\u6D88"
    }, /*#__PURE__*/React__default['default'].createElement(_DeleteOutlined__default['default'], {
      style: {
        fontSize: 17,
        marginLeft: 8
      }
    })), !props.hideAdd && /*#__PURE__*/React__default['default'].createElement(_CopyOutlined__default['default'], {
      style: {
        fontSize: 15,
        marginLeft: 8
      },
  ...
  }, !props.hideAdd && /*#__PURE__*/React__default['default'].createElement(_Button__default['default'], {
    type: "dashed",
    onClick: addItem
...
var CardList = function CardList(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    }, idx + 1), /*#__PURE__*/React__default['default'].createElement(Core, fieldsProps), /*#__PURE__*/React__default['default'].createElement(_Space__default['default'], {
...
var TableList = function TableList(_ref) {
  ...
  var columns = children.map(function (child) {
    ...
    return {
      dataIndex: child,
      title: schema.required ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("span", {
        className: "fr-label-required"
      }, " *"), /*#__PURE__*/React__default['default'].createElement("span", null, schema.title)) : schema.title,
      width: FIELD_LENGTH,
  ...
  if (!props.hideDelete) {
    columns.push({
      ...
      render: function render(value, record, idx) {
        return /*#__PURE__*/React__default['default'].createElement(_Popconfirm__default['default'], {
          title: "\u786E\u5B9A\u5220\u9664?",
          onConfirm: function onConfirm() {
            return deleteItem(idx);
          },
          okText: "\u786E\u5B9A",
          cancelText: "\u53D6\u6D88"
        }, /*#__PURE__*/React__default['default'].createElement("a", null, "\u5220\u9664"));
      }
    });
  }
  ...
  }) : null), /*#__PURE__*/React__default['default'].createElement(_Table__default['default'], {
    scroll: {
      x: 'max-content'
    },
    columns: columns,
...
var ErrorMessage = function ErrorMessage(_ref) {
  ...
  return !msg && hideValidation ? null : /*#__PURE__*/React__default['default'].createElement("div", {
...
var DrawerList = function DrawerList(_ref) {
  ...
  var _schema$props = schema.props,
      props = _schema$props === void 0 ? {} : _schema$props,
      itemProps = schema.itemProps;
  var currentIndex = React.useRef(-1);
  ...
  var columns = children.map(function (child) {
    ...
    return {
      ...
      render: function render(value, record) {
        ...
        return /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("div", null, getDisplayValue(value, schema)), errorObj.error && /*#__PURE__*/React__default['default'].createElement(ErrorMessage, {
  ...
  columns.push({
    ...
    render: function render(value, record, idx) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(_Space__default['default'], null, /*#__PURE__*/React__default['default'].createElement("a", {
        onClick: function onClick() {
          return openDrawer(index);
        }
      }, "\u7F16\u8F91"), !props.hideDelete && /*#__PURE__*/React__default['default'].createElement(_Popconfirm__default['default'], {
        title: "\u786E\u5B9A\u5220\u9664?",
        onConfirm: function onConfirm() {
  ...
  }) : null), /*#__PURE__*/React__default['default'].createElement(_Drawer__default['default'], {
    width: "600",
    title: "\u7F16\u8F91",
    placement: "right",
    onClose: closeDrawer,
  ...
  }, /*#__PURE__*/React__default['default'].createElement(Core, fieldsProps))), /*#__PURE__*/React__default['default'].createElement(_Table__default['default'], {
    scroll: {
      x: 'max-content'
    },
    columns: columns,
...
var RenderList = function RenderList(_ref) {
  ...
  if (typeof dataPath === 'string') {
    ...
    listData = lodashEs.get(formData, dataPath);
  }
  ...
  switch (renderWidget) {
    case 'list0':
      return /*#__PURE__*/React__default['default'].createElement(CardList, displayProps);

    case 'list1':
      return /*#__PURE__*/React__default['default'].createElement(SimpleList, displayProps);

    case 'list2':
      return /*#__PURE__*/React__default['default'].createElement(TableList, displayProps);

    case 'list3':
      return /*#__PURE__*/React__default['default'].createElement(DrawerList, displayProps);
...
var RenderObject = function RenderObject(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, children.map(function (child, i) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(Core, _extends({
      key: i.toString()
    }, FRProps));
  }));
};
...
var Title = function Title(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    ,
    title: title
  }, required === true && /*#__PURE__*/React__default['default'].createElement("span", {
    className: "fr-label-required"
  }, " *"), /*#__PURE__*/React__default['default'].createElement("span", {
    className: "".concat(isObjType ? 'b' : '', " ").concat(_displayType === 'column' ? 'flex-none' : '')
  }, title), description && (_displayType === 'row' ? /*#__PURE__*/React__default['default'].createElement("span", {
  ...
  }), description)) : _displayType === 'inline' ? null : /*#__PURE__*/React__default['default'].createElement("span", {
...
var Checkboxes = createWidget(mapProps)(_Checkbox__default['default'].Group);
...
function color(p) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(ColorPicker__default['default'], {
    type: format,
    animation: "slide-up",
    color: p.value && p.value.slice(0, 7) || '#ffffff',
    alpha: getAlphaFromHex(p.value),
    onChange: onPickerChange
  }), p.readonly ? /*#__PURE__*/React__default['default'].createElement("span", null, p.value || '#ffffff') : /*#__PURE__*/React__default['default'].createElement(_Input__default['default'], {
    placeholder: "#ffffff",
    disabled: p.disabled,
    value: p.value,
...
var date = (function (_ref) {
  ...
  if (_value) {
    _value = moment__default['default'](_value, dateFormat);
  }
  ...
  return /*#__PURE__*/React__default['default'].createElement(_DatePicker__default['default'], dateParams);
});
...
var time = (function (_ref) {
  ...
  var _value = value ? moment__default['default'](value, timeFormat) : undefined;
  ...
  return /*#__PURE__*/React__default['default'].createElement(_TimePicker__default['default'], timeParams);
});
...
var DateRange = function DateRange(_ref) {
  ...
  if (start && end) {
    _value = [moment__default['default'](start, dateFormat), moment__default['default'](end, dateFormat)];
  }
  ...
  dateParams = _objectSpread2(_objectSpread2({}, dateParams), rest);
  return /*#__PURE__*/React__default['default'].createElement(RangePicker, dateParams);
};

var RangePicker$1 = _TimePicker__default['default'].RangePicker;
...
var TimeRange = function TimeRange(_ref) {
  ...
  var _value = start && end ? [moment__default['default'](start, timeFormat), moment__default['default'](end, timeFormat)] : [];
  ...
  return /*#__PURE__*/React__default['default'].createElement(RangePicker$1, timeParams);
};
...
var Panel = _Collapse__default['default'].Panel;
function map$1(_ref) {
  var children = _ref.children,
      title = _ref.title,
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: "w-100"
  }, /*#__PURE__*/React__default['default'].createElement(_Collapse__default['default'], {
    defaultActiveKey: ['1']
...
var Radioes = createWidget(mapProps$1)(_Radio__default['default'].Group);
...
var Component = createWidget(mapProps$2)(_Select__default['default']);
...
var SliderWithNumber = function SliderWithNumber(_ref) {
  ...
  }, rest)), hideInput ? null : /*#__PURE__*/React__default['default'].createElement(_InputNumber__default['default'], _extends({}, setting, inputProps, {
    style: {
      width: '90px'
    },
    value: value,
...
function FrUpload(_ref) {
  ...
  var props = _objectSpread2({
    ...
    onChange: function onChange(info) {
      if (info.file.status === 'done') {
        _message__default['default'].success("".concat(info.file.name, " \u4E0A\u4F20\u6210\u529F"));

        _onChange(info.file.response.url);
      } else if (info.file.status === 'error') {
        _message__default['default'].error("".concat(info.file.name, " \u4E0A\u4F20\u5931\u8D25"));
      }
    },
  ...
  var defaultBtnProps = {
    icon: /*#__PURE__*/React__default['default'].createElement(_UploadOutlined__default['default'], null),
    children: '上传'
  };
  ...
  }, /*#__PURE__*/React__default['default'].createElement(_Upload__default['default'], _extends({}, props, {
    className: "fr-upload-file"
  }), /*#__PURE__*/React__default['default'].createElement(_Button__default['default'], btnProps)), value && /*#__PURE__*/React__default['default'].createElement("a", {
    href: value,
    target: "_blank",
...
var PreviewNode = function PreviewNode(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(_Popover__default['default'], {
    ...
    placement: "bottom"
  }, /*#__PURE__*/React__default['default'].createElement(_PictureOutlined__default['default'], null));
};
...
function imageInput(_ref2) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(_Input__default['default'], _extends({
    value: value,
    addonAfter: /*#__PURE__*/React__default['default'].createElement(PreviewNode, {
      value: value
    })
  }, rest));
}
...
var TestNode = function TestNode(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, "\u6D4B\u8BD5\u94FE\u63A5");
};
...
function imageInput$1(_ref2) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(_Input__default['default'], _extends({
    value: value,
    addonAfter: /*#__PURE__*/React__default['default'].createElement(TestNode, {
      value: value
    })
  }, rest));
}
...
var labelAndValueSetting = function labelAndValueSetting(p) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, "myselect", /*#__PURE__*/React__default['default'].createElement(_Select__default['default'], {
...
var FrCheckbox = function FrCheckbox(_ref4) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(_Checkbox__default['default'], _extends({
    style: _objectSpread2({
      paddingTop: 4,
      paddingBottom: 4
    }, style)
...
var FrTreeSelect = function FrTreeSelect(_ref5) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(_TreeSelect__default['default'], _extends({
    style: _objectSpread2({
      width: '100%'
    }, style)
  }, rest));
...
var FrCascader = function FrCascader(_ref6) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(_Cascader__default['default'], _extends({
    style: _objectSpread2({
      width: '100%'
    }, style)
  }, rest));
...
var ErrorSchema = function ErrorSchema(schema) {
  ...
  }, "schema\u672A\u5339\u914D\u5230\u5C55\u793A\u7EC4\u4EF6\uFF1A"), /*#__PURE__*/React__default['default'].createElement("div", null, JSON.stringify(schema)));
};
...
var ExtendedWidget = function ExtendedWidget(_ref) {
  ...
  if (!widgetName) {
    widgetName = 'input';
    return /*#__PURE__*/React__default['default'].createElement(ErrorSchema, {
      schema: schema
    });
  }
  ...
  return /*#__PURE__*/React__default['default'].createElement(Widget, finalProps);
};
...
var RenderField = function RenderField(props) {
  ...
  if (isCheckBoxType(_schema, _readOnly)) {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, _showTitle && /*#__PURE__*/React__default['default'].createElement("div", placeholderTitleProps), /*#__PURE__*/React__default['default'].createElement("div", {
      className: contentClass,
      style: contentStyle
    }, /*#__PURE__*/React__default['default'].createElement(ExtendedWidget$1, widgetProps), /*#__PURE__*/React__default['default'].createElement(ErrorMessage, messageProps)));
  }

  var titleElement = /*#__PURE__*/React__default['default'].createElement(Title, titleProps);
  ...
  if (isObjType(_schema)) {
    ...
    }, titleElement, /*#__PURE__*/React__default['default'].createElement(ErrorMessage, messageProps));
    return /*#__PURE__*/React__default['default'].createElement("div", {
      className: contentClass,
      style: contentStyle
    }, /*#__PURE__*/React__default['default'].createElement(ExtendedWidget$1, _extends({}, widgetProps, {
      message: errorMessage,
      title: _showTitle ? titleElement : undefined
    })));
  }

  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, _showTitle && titleElement, /*#__PURE__*/React__default['default'].createElement("div", {
...
var Core = function Core(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(MCore, dataProps);
};
...
var CoreRender = function CoreRender(_ref2) {
  ...
  var objChildren = /*#__PURE__*/React__default['default'].createElement("div", {
    className: "flex flex-wrap"
  }, /*#__PURE__*/React__default['default'].createElement(RenderObject, {
    dataIndex: dataIndex,
    errorFields: errorFields,
    displayType: _displayType,
    hideTitle: hideTitle
  }, item.children));
  var listChildren = /*#__PURE__*/React__default['default'].createElement(RenderList, {
    parentId: id,
    schema: schema,
    dataIndex: dataIndex,
    errorFields: errorFields,
  ...
  }, /*#__PURE__*/React__default['default'].createElement(RenderField, fieldProps, _children));
};
...
var MCore = /*#__PURE__*/React__default['default'].memo(CoreRender, areEqual$1);
...
var validateAll = function validateAll(_ref) {
  ...
  if (!isRequired) {
    touchedKeys.forEach(function (key) {
      ...
      var val = lodashEs.get(formData, key);
  ...
  try {
    validator = new Validator__default['default'](descriptor);
  } catch (error) {
    return Promise.resolve([]);
  }

  var messageFeed = locale === 'en' ? en : cn;
  lodashEs.merge(messageFeed, validateMessages);
...
var transformDataWithBind = function transformDataWithBind(data, flatten) {
  ...
  var handleBindData = function handleBindData(formData) {
    unbindKeys.forEach(function (key) {
      lodashEs.unset(formData, key); // TODO: 光remove了一个key，如果遇到remove了那个key上层的object为空了，object是不是也要去掉。。。不过感觉是伪需求
    });
    bindKeys.forEach(function (item) {
      var key = item.key,
          bind = item.bind;
      var temp = lodashEs.get(formData, key); // 如果已经有值了，要和原来的值合并，而不是覆盖

      var oldVal = lodashEs.get(formData, bind);

      if (isObject(oldVal)) {
        temp = _objectSpread2(_objectSpread2({}, oldVal), temp);
      }

      lodashEs.set(formData, bind, temp);
      lodashEs.unset(formData, key);
    });
    bindArrKeys.forEach(function (item) {
      var key = item.key,
          bind = item.bind;
      var temp = lodashEs.get(formData, key);

      if (Array.isArray(temp)) {
        temp.forEach(function (t, i) {
          if (bind[i]) {
            lodashEs.set(formData, bind[i], t);
          }
        });
      }
...
var transformDataWithBind2 = function transformDataWithBind2(data, flatten) {
  ...
  var handleBindData2 = function handleBindData2(newData) {
    bindKeys.forEach(function (item) {
      var key = item.key,
          bind = item.bind;
      var temp = lodashEs.get(newData, bind); // 如果已经有值了，要和原来的值合并，而不是覆盖

      var oldVal = lodashEs.get(newData, key);

      if (isObject(oldVal)) {
        temp = _objectSpread2(_objectSpread2({}, oldVal), temp);
      }

      lodashEs.set(newData, key, temp);
      lodashEs.unset(newData, bind);
    });
    bindArrKeys.forEach(function (item) {
      var key = item.key,
          bind = item.bind;
      ...
      bind.forEach(function (b) {
        temp.push(lodashEs.get(newData, b));
        lodashEs.unset(newData, b);
      });
      lodashEs.set(newData, key, temp);
    });
  };
...
var useForm = function useForm(props) {
  ...
  var beforeFinishRef = React.useRef(function () {});
  var onMountRef = React.useRef();
  ...
  var _flatten = React.useRef({}); // 用ref是为了破除闭包的影响
  ...
  _data.current = React.useMemo(function () {
    return lodashEs.merge(generateDataSkeleton(schemaRef.current), formData);
  ...
  var onItemChange = function onItemChange(path, value) {
    ...
    lodashEs.set(_data.current, path, value);
  ...
  var setErrorFields = function setErrorFields(error) {
    ...
    newErrorFields = lodashEs.sortedUniqBy(newErrorFields, function (item) {
      return item.name;
    });
...
function App(_ref) {
  ...
  var store2 = React.useMemo(function () {
    return {
      displayType: displayType,
      theme: theme,
      column: column,
  ...
  return /*#__PURE__*/React__default['default'].createElement(_ConfigProvider__default['default'], _extends({
    locale: zhCN__default['default']
  }, configProvider), /*#__PURE__*/React__default['default'].createElement(StoreCtx.Provider, {
    value: store
  }, /*#__PURE__*/React__default['default'].createElement(Store2Ctx.Provider, {
    value: store2
  ...
  }, /*#__PURE__*/React__default['default'].createElement("div", null, 'formData:' + JSON.stringify(form.formData)), /*#__PURE__*/React__default['default'].createElement("div", null, 'errorFields:' + JSON.stringify(form.errorFields)), /*#__PURE__*/React__default['default'].createElement("div", null, 'touchedKeys:' + JSON.stringify(form.touchedKeys)), /*#__PURE__*/React__default['default'].createElement("div", null, 'allTouched:' + JSON.stringify(form.allTouched)), /*#__PURE__*/React__default['default'].createElement("div", null, 'isEditting:' + JSON.stringify(form.isEditing)), /*#__PURE__*/React__default['default'].createElement("div", null, 'isValidating:' + JSON.stringify(form.isValidating)), /*#__PURE__*/React__default['default'].createElement("div", null, 'isSubmitting:' + JSON.stringify(form.isSubmitting))) : null, watchList.length > 0 ? watchList.map(function (item, idx) {
    return /*#__PURE__*/React__default['default'].createElement(Watcher, {
      key: idx.toString(),
      watchKey: item,
      watch: watch,
      formData: formData
...
var Wrapper = function Wrapper(props) {
  ...
  var _schema = React.useRef(schema);

  if (isOldVersion) {
    _schema.current = updateSchemaToNewVersion(schema);
  }

  return /*#__PURE__*/React__default['default'].createElement(App, _extends({
